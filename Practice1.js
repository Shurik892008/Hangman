...
//word array
const question = [
  "Обрана категорія - Футбольні клуби премєр ліги",
  "Обрана категорія - Фільми",
  "Обрана категорія - Міста"
];
...
function showHint() {
  containerHint.innerHTML = `Текст підказки - ${hint}`;
}
...
function init() {
  ...
  canvas();
  containerHint.innerHTML = `Текст підказки -`;
  livesDisplay.innerHTML = `Ви маєте ${life} життів!`;
  setAnswer();
  ...
  if (answer === winningCheck) {
    ...
    if (life > 0) {
      ...
      if (life > 1) {
        ...
        livesDisplay.innerHTML = `Ви маєте ${life} життя!`;
      } else {
